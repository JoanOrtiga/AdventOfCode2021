...
namespace Day2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            MoveSubmarine(instructions, out finalHorizontalPosition, out finalDepthPosition);
        ...
        static void MoveSubmarine(List<Instruction> movements, out int horizontalPosition, out int depthPosition)
        {
            ...
            for (int i = 0; i < movements.Count; i++)
            {
                switch (movements[i].type)
                {
                    ...
                    {
                        depthPosition -= movements[i].quantity;
                    } break;
